function [out] = dfa_steptheta_wtrack_forelimb(index,excludeperiods,eeg,eeggnd,~,varargin)

%  dfa_steptheta_wtrack_forelimb 
...
%  Forelimb and Hindlimb steps 
    ...
    if ((~iscell(varargin{1,1}{1,d})) || (isempty(run_periods)) || (isempty(varargin{1,1}{1,d}{1,e})) || (~exist(postfile)))
        ...
        out.forelimb_midstance_outbound=nan;
        out.hindlimb_midstance_outbound=nan;

        out.forelimb_midswing_outbound=nan;
        out.hindlimb_midswing_outbound=nan;
        ...
        out.forelimb_phase_midstance_outbound=nan;
        out.hindlimb_phase_midstance_outbound=nan;

        out.forelimb_amp_midstance_outbound=nan;
        out.hindlimb_amp_midstance_outbound=nan;  

        out.forelimb_phase_midswing_outbound=nan;
        out.hindlimb_phase_midswing_outbound=nan;

        out.forelimb_amp_midswing_outbound=nan;
        out.hindlimb_amp_midswing_outbound=nan;
        ...
        out.forelimb_midstance_inbound=nan;
        out.hindlimb_midstance_inbound=nan;

        out.forelimb_midswing_inbound=nan;
        out.hindlimb_midswing_inbound=nan;
        ...
        out.forelimb_phase_midstance_inbound=nan;
        out.hindlimb_phase_midstance_inbound=nan;

        out.forelimb_amp_midstance_inbound=nan;
        out.hindlimb_amp_midstance_inbound=nan;  

        out.forelimb_phase_midswing_inbound=nan;
        out.hindlimb_phase_midswing_inbound=nan;

        out.forelimb_amp_midswing_inbound=nan;
        out.hindlimb_amp_midswing_inbound=nan;
        ...
        [forelimb_phase_results_outbound,results_forelimb_outbound]=thetaphase_assign(cam_rt_fit_forelimb_outbound,theta_time, phase_hpc, amplitude, min_steps);
        ...
        [hindlimb_phase_results_outbound,results_hindlimb_outbound]=thetaphase_assign(cam_rt_fit_hindlimb_outbound,theta_time, phase_hpc, amplitude, min_steps);
    
        %%   Forelimb inbound
        [cam_rt_fit_forepawL_results_inbound, ~,~, ~]=smooth_dlc_stepcycles_wtrack(dlc_tail_x,(dlc_forepawL_x+dlc_forepawL_y), cam_rt_fit, dlc_nose_vel, est_framerate, inbound_center, index);
        [cam_rt_fit_forepawR_results_inbound, ~,~, ~]=smooth_dlc_stepcycles_wtrack(dlc_tail_x,(dlc_forepawR_x+dlc_forepawR_y), cam_rt_fit, dlc_nose_vel, est_framerate, inbound_center, index);
        ...
        % Forelimb combined phase results  
        [forelimb_phase_results_inbound,results_forelimb_inbound]=thetaphase_assign(cam_rt_fit_forelimb_inbound,theta_time, phase_hpc, amplitude, min_steps);

        % Hindlimb inbound
        [cam_rt_fit_hindpawR_results_inbound, ~,~, ~]=smooth_dlc_stepcycles_wtrack(dlc_tail_x,(dlc_hindpawR_x+dlc_hindpawR_y), cam_rt_fit, dlc_nose_vel, est_framerate, inbound_center, index);
        [cam_rt_fit_hindpawL_results_inbound, ~,~, ~]=smooth_dlc_stepcycles_wtrack(dlc_tail_x,(dlc_hindpawL_x+dlc_hindpawL_y), cam_rt_fit, dlc_nose_vel, est_framerate, inbound_center, index);
        ...
        % hindlimb combined phase results  
        [hindlimb_phase_results_inbound,results_hindlimb_inbound]=thetaphase_assign(cam_rt_fit_hindlimb_inbound,theta_time, phase_hpc, amplitude, min_steps);
        ...
        out.forelimb_midstance_outbound=results_forelimb_outbound(5,:);
        out.hindlimb_midstance_outbound=results_hindlimb_outbound(5,:);

        out.forelimb_midswing_outbound=results_forelimb_outbound(6,:);
        out.hindlimb_midswing_outbound=results_hindlimb_outbound(6,:);
        ...
        out.forelimb_phase_midstance_outbound=forelimb_phase_results_outbound.midstance;
        out.hindlimb_phase_midstance_outbound=hindlimb_phase_results_outbound.midstance;

        out.forelimb_amp_midstance_outbound=forelimb_phase_results_outbound.amp_midstance;
        out.hindlimb_amp_midstance_outbound=hindlimb_phase_results_outbound.amp_midstance;  

        out.forelimb_phase_midswing_outbound=forelimb_phase_results_outbound.midswing;
        out.hindlimb_phase_midswing_outbound=hindlimb_phase_results_outbound.midswing;

        out.forelimb_amp_midswing_outbound=forelimb_phase_results_outbound.amp_midswing;
        out.hindlimb_amp_midswing_outbound=hindlimb_phase_results_outbound.amp_midswing;
        ...
        out.forelimb_midstance_inbound=results_forelimb_inbound(5,:);
        out.hindlimb_midstance_inbound=results_hindlimb_inbound(5,:);

        out.forelimb_midswing_inbound=results_forelimb_inbound(6,:);
        out.hindlimb_midswing_inbound=results_hindlimb_inbound(6,:);
        ...
        out.forelimb_phase_midstance_inbound=forelimb_phase_results_inbound.midstance;
        out.hindlimb_phase_midstance_inbound=hindlimb_phase_results_inbound.midstance;

        out.forelimb_amp_midstance_inbound=forelimb_phase_results_inbound.amp_midstance;
        out.hindlimb_amp_midstance_inbound=hindlimb_phase_results_inbound.amp_midstance;  

        out.forelimb_phase_midswing_inbound=forelimb_phase_results_inbound.midswing;
        out.hindlimb_phase_midswing_inbound=hindlimb_phase_results_inbound.midswing;

        out.forelimb_amp_midswing_inbound=forelimb_phase_results_inbound.amp_midswing;
        out.hindlimb_amp_midswing_inbound=hindlimb_phase_results_inbound.amp_midswing;
